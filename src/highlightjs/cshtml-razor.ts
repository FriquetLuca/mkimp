...
export function razor(hljs: HLJSApi) {
    ...
    const xml_blocks = getXmlBlocks(hljs, [razor_inline_expresion, razor_parentheses_block as Mode]);
    ...
    [razor_block, razor_code_block, razor_try_block]
        .forEach(function (mode) {
            ...
            mode.contains.splice.apply(mode.contains, [replacerIndex, 1].concat(razorModes as any) as any);
        });
