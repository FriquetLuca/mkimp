...
export function flattenJSONintoMap(obj: any, map: Map<string, string>, prefix = '') {
...
export function cutCharFollowedByWhitespace(character: string, content: string) {
...
export function extractUnorderedListItem(symbol: string, content: string, tabSpace: number, pSkip = false) {
